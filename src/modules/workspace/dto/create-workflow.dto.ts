...
export class CreateWorkflowDto {
  ...
  @ApiProperty({ example: 'Nightly invoice sync', minLength: 1, maxLength: 250 })
  @IsString()
  @Transform(trim)
  // Bounds match the column (VarChar(250)). Validating here rather than letting
  // Postgres reject it turns a 500 into a 422 that names the field.
  @MinLength(1)
  @MaxLength(250)
  name!: string;
